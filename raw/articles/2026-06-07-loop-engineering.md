...
tags: [loop-engineering, agentic-workflows, agent-harness, automations, worktrees, agent-skills, subagents, mcp, claude-code, codex, verification]
---

# Loop Engineering

> 프롬프트를 잘 쓰는 능력보다, 프롬프트를 대신 던지는 루프를 설계하는 능력이 중요해진다. 다섯 개의 building block(automations, worktrees, skills, plugins/connectors, sub-agents)과 하나의 외부 state가 그 루프를 구성한다.
